...
\todo{
	...
	\begin{itemize}
		...
		\item paper lint
		\item check tense
		\item naive bayes capitalized?
		\item Check figure vs. table vs. equation
		\item Two stage classifier vs Two-staged classification
	\item noise to opportunity writing
	\end{itemize}
}
