...
\todo{
	\begin{itemize}
	\item Nicht e-commerce sondern z.B. SaaS als alternative Motivation: Since companies, especially Software, 	move from big service contracts to small cloud products Sales people have less time to find customers
	...
	\item figure one --> use figure from concept (2 stage classifier)
	\end{itemize}	
}
