...
The intersection of the most relevant words for demand and product classification is the empty set.\todo{Is it really empty?: What about: Talking about buying a product could express a demand for another product or listing requirements/feautures of a product could express a demand...}
...
\begin{figure}
	\begin{alignat*}{3}
	  ...
	  &\mathbf{NTO}: && ~~p   && \longmapsto \begin{cases}
	   ...
	   \end{cases}
	\end{alignat*}
	\caption{Defining \nto via two-staged classifation.}
\end{figure}
...
We did this manually for a randomly selected sample of social network posts. \todo{What about active learning? Is this random?}
