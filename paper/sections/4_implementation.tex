...
\begin{align*}
	...
	\end{cases}
	\end{align*}
	\caption{Bernoulli na\"{i}ve bayes definition~\cite{mccallum1998comparison}. \todo{Do not start with small letter.} The letter d is the document. C is the class. w is a term in a document and vocabulary V is the set of all terms in all documents}
\end{equationBlock}
...
Generally the linear classifiers like logistic regression, svm, and perceptron performs better then the others. 
