...
Furthermore, McCallum et~al.~\cite{mccallum1998comparison} state ``that the multi-variate Bernoulli performs well with small vocabulary sizes''~\cite{mccallum1998comparison}.
