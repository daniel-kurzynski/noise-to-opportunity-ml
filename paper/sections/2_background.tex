...
Yang et al.\cite{yang1999re} have compared the performance of different text classifiers in their paper, McCallum et al. \cite{mccallum1998comparison} specifically focus on na\"ive bayes classifiers, Han et al. \cite{han2001text} propose an improved k-Nearest-Neighbors algorithm.
