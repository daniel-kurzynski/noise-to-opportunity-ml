...
In a learning task the instances should be drawn from the same population in the training phase as the instances which are to be classified in the end.\todo{Daniel: Needs reference from Bishop. Am besten quoten. Im Bishop nichts passendes gefunden! Daniel, search harder!!!}
