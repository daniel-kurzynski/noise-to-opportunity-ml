...
plot \
	'./data_with_none.csv' every 3::1 using 1:3 with boxes lt rgb color_1 title "10 most occured words" , \
	'./data_with_none.csv' every 3::1 using 1:($3+2):3 with labels notitle, \
	'./data_with_none.csv' every 3::2 using 1:3 with boxes lt rgb color_2 title "100 most occured words" , \
	'./data_with_none.csv' every 3::2 using 1:($3+2):3 with labels notitle, \
	'./data_with_none.csv' every 3 		using 1:3 with boxes lt rgb color_3 title "1000 most occured words", \
