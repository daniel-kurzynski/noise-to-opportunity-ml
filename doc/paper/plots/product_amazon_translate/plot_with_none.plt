...
plot \
	...
	'data_with_none.csv' every 4::1 using 1:($3+6):3 with labels rotate by 90 notitle, \
	'data_with_none.csv' every 4::2 using 1:3 with boxes lt rgb color_2 title "Translated only" , \
	'data_with_none.csv' every 4::2 using 1:($3+6):3 with labels rotate by 90 notitle, \
	'data_with_none.csv' every 4::3 using 1:3 with boxes lt rgb color_3 title "Amazon only" , \
	'data_with_none.csv' every 4::3 using 1:($3+6):3 with labels rotate by 90 notitle, \
	'data_with_none.csv' every 4    using 1:3 with boxes lt rgb color_4 title "Original brochures", \
	'data_with_none.csv' every 4    using 1:($3+6):3 with labels rotate by 90 notitle
